import argparse
import os
from solver_cam_focal_ours1_dqn import Solver
...
if __name__ == '__main__':
    for i in range(5):
        ...
        parser.add_argument('--output_path', type=str,
                            default='/home/ubuntu/liuyiyao/breast_multimodal_project/mini_output_testcam_focal/fix_testset/fold_%d' % i)
        ...
        parser.add_argument('--checkpoint', type=str,
                            default='/home/ubuntu/liuyiyao/covid19_project/output/resnet/resnet18_StepLR_SGD/20220925-1525/model/1000-0.000100-950-0.5000_best.pkl')
